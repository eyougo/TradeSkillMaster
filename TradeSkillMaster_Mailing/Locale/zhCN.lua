...
L["Send all %s to %s - %s per Item COD"] = "发送所有的%s 给 %s - 每件收费 %s"
L["Send %sx%d to %s - %s per Item COD"] = "发送%s %d个 给 %s - 每件收费 %s"
L["Send all %s to %s - No COD"] = "发送所有的%s 给 %s - 无收费"
L["Send %sx%d to %s - No COD"] = "发送%s %d个 给 %s - 无收费"
L["Send Money:"] = "发送钱币金额:"
L["Send money %s to %s"] = "发送钱币%s 给%s"
L["Send all %s money %s to %s"] = "发送所有的%s 和钱币%s 给%s"
L["Send %sx%d money %s to %s"] = "发送%s %d个 和钱币%s 给%s"
...
L["Sent %s and money %s to %s."] = "邮寄%s和钱币%s给%s。"
L["Sent money %s to %s."] = "邮寄钱币%s给%s"
